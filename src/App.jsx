...
// ══ DATA ══════════════════════════════════════════════════════════════════════
// ── 마지막 데이터 업데이트: 2026-03-19 ─────────────────────────────────────────
const AIRLINES = [
  {code:"EK",name:"Emirates",            hub:"DXB",city:{ko:"두바이",    en:"Dubai"},     status:"주의", affected:true, note:{ko:"80개 목적지 106편 왕복 운항 중(전쟁 전 60%). 140개 목적지 100% 복구 목표. 환승은 연결편 확정 시에만 허용. 출발 1시간 전 반드시 항공사 확인. 2/28~3/31 발권 → 4/30 무료 재예약.",en:"80 destinations, 106 daily return flights (~60% of pre-war). Targeting 100% of 140 destinations. Transit only if connection confirmed. Check 1hr before departure. Feb 28–Mar 31 → free rebook to Apr 30."}},
  ...
  {code:"QR",name:"Qatar Airways",       hub:"DOH",city:{ko:"도하",      en:"Doha"},      status:"주의", affected:true, note:{ko:"3/18~28 개정 일정 발표. 3/19 도하발 약 50편 운항(전쟁 전 약 20%). 3/28 완전 재개 목표. 확정 탑승권 없이 공항 방문 금지. 2/28~3/28 발권 → 4/30까지 무료 변경 또는 환불.",en:"Revised schedule Mar 18–28. ~50 daily Doha departures Mar 19 (~20% pre-war). Full resumption target: Mar 28. No airport without confirmed ticket. Feb 28–Mar 28 → free change or refund to Apr 30."}},
  {code:"WY",name:"Oman Air",            hub:"MCT",city:{ko:"무스카트",  en:"Muscat"},    status:"주의", affected:false,note:{ko:"무스카트 정상 운항. 단 암만·두바이·바레인·도하·다맘·쿠웨이트·코펜하겐·바그다드 3/31까지 취소 연장. SalamAir 3/16~27 카이로 추가편 운항.",en:"Muscat normal ops. BUT Amman/Dubai/Bahrain/Doha/Dammam/Kuwait/Copenhagen/Baghdad cancelled EXTENDED to Mar 31. SalamAir extra Cairo flights Mar 16–27."}},
  ...
  {code:"ME",name:"Middle East Airlines",hub:"BEY",city:{ko:"베이루트",  en:"Beirut"},    status:"주의", affected:true, note:{ko:"베이루트 축소 운항 유지. 레바논 영공 기술적 개방이나 인근 불안정 지속. BA, 아부다비·암만·바레인·도하·두바이·텔아비브 최소 3/17까지 운항 불가.",en:"Reduced Beirut ops. Lebanese airspace open but unstable. BA unable to operate Abu Dhabi/Amman/Bahrain/Doha/Dubai/Tel Aviv at least through Mar 17."}},
  {code:"TK",name:"Turkish Airlines",    hub:"IST",city:{ko:"이스탄불",  en:"Istanbul"},  status:"운항중",affected:false,note:{ko:"이스탄불 정상 운항. 이라크·시리아·레바논·요르단·도하·두바이·아부다비·쿠웨이트·바레인·다맘 3/19, 이란 3/20까지 취소 후 재개 예정. 3/31까지 무료 변경.",en:"Istanbul normal ops. Iraq/Syria/Lebanon/Jordan/Doha/Dubai/Abu Dhabi/Kuwait/Bahrain/Dammam cancelled to Mar 19, Iran to Mar 20 — then expected to resume. Free changes to Mar 31."}},
  ...
  {code:"LY",name:"El Al",              hub:"TLV",city:{ko:"텔아비브",  en:"Tel Aviv"},  status:"주의", affected:true, note:{ko:"3/29까지 정기편 전면 취소. 취리히·베를린·바르셀로나·보스턴·프랑크푸르트 등 일부 노선 완전 중단. 제한 구조편만 운항 중.",en:"Regular flights cancelled until Mar 29. Zurich/Berlin/Barcelona/Boston/Frankfurt etc not operating. Limited rescue flights only."}},
...
const AIRSPACE = [
  ...
  {country:{ko:"이라크",        en:"Iraq"},          status:"폐쇄",note:{ko:"ORBB/Baghdad FIR 전면 폐쇄 반복 연장 중. 지역 내 마지막으로 재개될 전망.",    en:"ORBB/Baghdad FIR fully closed — repeatedly extending. Last airspace in region expected to reopen."}},
  ...
  {country:{ko:"UAE",           en:"UAE"},           status:"제한",note:{ko:"3/17 새벽 드론 요격으로 일시 폐쇄 후 05:00 재개. ESCAT 운용 중. DXB·DWC UAE 항공사 우선 운항. 이달 드론 공격 4회 — 재폐쇄 언제든 가능.",      en:"Mar 17 briefly closed overnight then reopened 05:00. ESCAT active. DXB/DWC prioritizing UAE airlines. 4 drone incidents this month — closure possible at any time."}},
...
const AIRPORTS = [
  {iata:"DXB",name:{ko:"두바이 국제공항",          en:"Dubai International"},      city:{ko:"두바이",   en:"Dubai"},    status:"제한",airline:"Emirates / flydubai",
   detail:{ko:"3/17 새벽 일시 폐쇄 후 05:00 재개. Emirates 110개 목적지 운항 중. 이달 드론 공격 4회. Lufthansa 그룹 3/28까지 취소. KLM·Air France·Finnair·BA 3월 말까지 미운항. 확정 탑승권 없이 방문 금지.",en:"Mar 17 briefly closed overnight then reopened 05:00. Emirates serving 110 destinations. 4 drone incidents this month. Lufthansa Group cancelled to Mar 28. KLM/Air France/Finnair/BA not flying until end of March. Confirmed booking required."},
   date:"2026-03-17",
   warn:{ko:"출발 1시간 전 반드시 항공사 앱으로 편 확인 — 수시로 상황 변동",en:"Check flight status 1hr before departure — situation changes without notice"},site:"https://dubaiairports.ae"},
  ...
  {iata:"DOH",name:{ko:"하마드 국제공항",          en:"Hamad International"},      city:{ko:"도하",     en:"Doha"},     status:"제한",airline:"Qatar Airways",
   detail:{ko:"3/18~28 개정 제한 일정 운항 중. 3/19 약 50편 도하 출발(전쟁 전 20%). 3/28 도하 FIR 완전 재개 목표. 확정 탑승권 없이 공항 방문 절대 금지.",en:"Revised limited schedule Mar 18–28. ~50 departures Mar 19 (~20% pre-war). Full Doha FIR reopening target: Mar 28. Do NOT go without confirmed ticket."},
   date:"2026-03-19",
   warn:{ko:"확정 탑승권 없이 공항 방문 절대 금지 — 3/28 완전 재개 목표",en:"Do NOT go without confirmed ticket — targeting full resumption Mar 28"},site:"https://dohahamadairport.com"},
...
// ── 최신 뉴스 데이터 (수동 업데이트) ─────────────────────────────────────────
const STATIC_NEWS = [
  {icon:"📢",tag:"Emirates",    severity:"high",  time:"3/19",content:"Emirates, 80개 목적지 106편 왕복 운항(전쟁 전 60%). 140개 목적지 100% 복구 목표. 환승은 연결편 확정 시에만. 출발 1시간 전 emirat.es/flightstatus 확인 필수.",                    source:"emirates.com",    fresh:true},
  {icon:"📢",tag:"Qatar",       severity:"high",  time:"3/19",content:"Qatar Airways, 3/18~28 개정 일정 운항 중. 3/19 도하발 약 50편(전쟁 전 20%). 3/28 도하 FIR 완전 재개 목표. 확정 탑승권 없이 공항 방문 금지. 2/28~3/28 발권 → 4/30 무료 변경.",   source:"qatarairways.com",fresh:true},
  {icon:"📢",tag:"Etihad",      severity:"high",  time:"3/19",content:"Etihad, 전쟁 전 약 30% 운항. 런던·프랑크푸르트·파리·뉴욕·시드니 포함 증편 지속. 2/28 이전 발권·3/21까지 여행 → 5/15까지 무료 재예약 또는 환불.",                               source:"etihad.com",      fresh:true},
  {icon:"⛔",tag:"유럽항공사",   severity:"high",  time:"3/19",content:"BA 두바이 5/31, 도하 4/30까지 취소(유럽 최장). Lufthansa 그룹·KLM 3/28까지. Air France 두바이 3/20, 텔아비브 3/21부터 재개 예정. Finnair 두바이 3/29, 도하 4/2까지 취소.",      source:"Euronews",        fresh:true},
  {icon:"⛔",tag:"Turkish",     severity:"medium",time:"3/19",content:"Turkish Airlines, 이라크·시리아·레바논·요르단·두바이·아부다비·쿠웨이트·바레인·다맘 3/19, 이란 3/20까지 취소 후 재개 예정. 이스탄불(IST) 가장 안정적인 경유지.",                   source:"Jerusalem Post",  fresh:true},
  {icon:"⛔",tag:"이란·이라크",  severity:"high",  time:"3/19",content:"이란(OIIX)·이라크(ORBB) 영공 반복 연장 폐쇄 지속. 이라크는 지역 내 마지막으로 재개될 전망. 이 두 영공 우회로 비행시간 최대 2시간 증가.",                                       source:"NOTAM/FR24",      fresh:true},
  {icon:"🚨",tag:"El Al",       severity:"high",  time:"3/19",content:"El Al, 3/29까지 정기편 전면 취소. 취리히·베를린·바르셀로나·보스턴·프랑크푸르트·런던루턴·비엔나 등 일부 노선 아예 미운항. 제한 구조편만 운항.",                                   source:"Jerusalem Post",  fresh:true},
  {icon:"✅",tag:"무스카트",    severity:"low",   time:"3/19",content:"무스카트(MCT) 우회 거점 유지. Oman Air 암만·두바이·바레인·도하·다맘·쿠웨이트 3/31까지 취소 연장. 단 무스카트 자체 정상 운항. SalamAir 카이로 추가편 3/27까지.",                    source:"Oman Air",        fresh:true},
  {icon:"📢",tag:"Gulf Air",    severity:"medium",time:"3/19",content:"Gulf Air, 바레인 영공 폐쇄로 다맘(DMM) 기반 운항. 다맘發 프랑크푸르트·나이로비·런던·뭄바이·방콕 3/28까지. 3/31까지 무료 변경, 3/21까지 무료 환불.",                              source:"Gulf Air/Euronews",fresh:true},
  {icon:"✅",tag:"Air France",  severity:"low",   time:"3/19",content:"Air France, 두바이 3/20(현지 출발 3/21), 텔아비브·베이루트 3/21부터 재개 예정. KLM 두바이·리야드·다맘 3/28까지 취소. Air Canada 두바이 3/23부터 재개 예정.",                      source:"Euronews",        fresh:true},
  ...
  {icon:"🚨",tag:"항공료급등",   severity:"medium",time:"3/19",content:"제트연료 $4.12/갤런 — 4년래 최고가. Wizz Air 두바이·아부다비·암만·제다 9월 중순까지 취소. 중동 우회로 유럽~아시아 비행 최대 2시간 증가. 여름 항공료 인상 전망.",                  source:"TravelPirates/Newsweek",fresh:false},
];
